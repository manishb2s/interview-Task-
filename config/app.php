...
return [
    ...
    | framework needs to place the application's name in a notification or any other
    ...
    */
    ...
    |
    | We have gone ahead and set this to a sensible default for you out of
    | the box.
    |
    */
    ...
    */
    ...
    | is not available.
    |
    | You may change the value to correspond to any of the language folders
    | that are provided through your application.
    |
    */
    ...
    |
    | For example, this will be used to get localized telephone numbers,
    | street address information and more.
    |
    */
    ...
    | to a random, 32 character string, otherwise these encrypted strings will
    | not be safe.
    |
    ...
    */
    ...
    'key' => env(
        'APP_KEY',
        'base64:nKBscjGEZtf8o5B9HvWi5dB2u/1E4LXvNzTZmQDrkIY='
    ),
    'cipher' => 'AES-256-CBC',
