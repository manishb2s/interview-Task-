...
return [
    ...
    | API, giving you convenient access to each back-end using the same syntax for
    | every one.
    |
    ...
    */
    ...
    |
    | A default configuration has been added for each back-end shipped with
    | Laravel.
    |
    | You are free to add more. Drivers: "sync", "database", "beanstalkd",
    | "sqs", "redis", "null"
    |
    */
