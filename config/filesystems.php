...
return [
    ...
    */
    ...
    | reason, you may specify a default "cloud" driver here.
    |
    | This driver will be bound as the Cloud disk implementation in the
    | container.
    |
    */
    ...
    |
    | Defaults have been setup for each driver as an example of the required
    | options.
    |
