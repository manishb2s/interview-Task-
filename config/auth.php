...
return [
    ...
    */
    ...
    | users are actually retrieved out of your database or other storage mechanisms
    ...
    */
    ...
    |
    | These sources may then be assigned to any extra authentication guards
    | you have defined.
    |
    ...
    */
    ...
    | considered valid.
    |
    | This security feature keeps tokens short-lived so they have less time
    | to be guessed.
    |
    ...
    */
    ...
    | confirmation times out and the user is prompted to re-enter their password via the
    | confirmation screen.
    |
