...
return [
    ...
    |
    | The name specified in this option should match one of the channels
    ...
    */
    ...
    |
    | This gives you a variety of powerful log handlers / formatters to
    | utilize.
    |
    ...
    */
    ...
    'channels' => [
        ...
        'single' => [
            'driver' => 'single',
            'path' => storage_path('storage/logs/laravel.log'),
            'level' => 'info',
        ],
        'daily' => [
            'driver' => 'daily',
